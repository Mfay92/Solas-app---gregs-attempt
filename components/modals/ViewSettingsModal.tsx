...
type SetViewSettings = {
    ...
    setDrawerMode: React.Dispatch<React.SetStateAction<'right' | 'bottom'>>;
                ...
                <div className="space-y-6">
                    <section>
                     ...
                     <section>
                        ...
                        <ViewTypeSelector isOpen={true} onClose={() => {}} currentView={viewMode} onSelectView={setViewMode} />
                    </section>
                     <section>
                        <h4 className="font-semibold text-solas-dark mb-3">Detail Panel Position</h4>
                        <PanelPositionSelector isOpen={true} onClose={() => {}} currentMode={drawerMode} onSelectMode={setDrawerMode} />
                    </section>
                </div>
            );
        }
