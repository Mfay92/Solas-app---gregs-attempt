    ...
    <Card title="Funding Details" titleClassName="text-solas-dark">
      <div className="space-y-4">
        <div>
          ...
          <p className="text-md text-gray-900">{funding.source}</p>
        </div>
        <div>
          <h4 className="font-semibold text-sm text-gray-700">Weekly Amount</h4>
          <p className="text-md text-gray-900">£{funding.weeklyAmount.toFixed(2)}</p>
        </div>
        <div>
          <h4 className="font-semibold text-sm text-gray-700">Details</h4>
          <p className="text-md text-gray-900">{funding.details || 'No additional details provided.'}</p>
        </div>
      </div>
    </Card>
  );
