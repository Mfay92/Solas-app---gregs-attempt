 ...
 *
 * Data structures for managing personal, team, and company-wide projects.
 * Each project represents a coordinated effort with tasks, deadlines, and stakeholders.
 */
...
export type ProjectType = 'Personal' | 'Team' | 'Company-Wide';
...
export const PROJECT_TYPES: ProjectType[] = ['Personal', 'Team', 'Company-Wide'];
